   ...
   <Context.Provider value={context}>
    <div className="flex min-h-screen space-x-2">
      ...
      >
        ...
        <div className="mb-4">
        {context.questions[questionid].ques_image!==null &&  <img src={context.questions[questionid].ques_image} alt="Question Image" className="w-64 h-64"  />}
        </div>
        <RadioGroup
        ...
        <div className="md:flex md:flex-row md:justify-between md:mt-auto text-gray-500 mt-4">
          <Button variant="outline" className="flex space-x-2 items-center " disabled={questionid===0} onClick={()=>{
          ...
          <Button variant="outline" className="flex space-x-2 items-center" disabled={questionid===context.questions.length-1} onClick={()=>{
            setquestionid(questionid+1);
          }}>
      ...
      >
        ...
        <div>
{context.questions[questionid].ans_image!==null &&          <img src={context.questions[questionid].ans_image} alt="Answer" />
}        </div>
      </div>
    </div>
   </Context.Provider>
